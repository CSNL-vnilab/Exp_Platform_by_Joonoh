...
const baseNavItems = [
  ...
  { label: "참여자 관리", href: "/participants", icon: ParticipantsIcon },
  { label: "전체 일정", href: "/schedule", icon: ScheduleIcon },
];

const adminNavItems = [
  { label: "메타데이터 보완", href: "/metadata-fill", icon: MetadataFillIcon },
  ...
  { label: "랩 설정", href: "/lab-settings", icon: SettingsIcon },
];
...
function ParticipantsIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
function MetadataFillIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
