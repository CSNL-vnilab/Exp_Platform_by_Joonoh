...
CHECK; 00081 DROP experiments.offline_code_analysis (analyzer removed);
00082 DROP notification_log + reset_payment_link_dispatch. The marker was
stale at 00069 while 00070–00077 were already applied out-of-band — it is
now advanced to the true frontier.)

Earlier marker: `00069_slot_increment_and_overlap_conflict.sql`
